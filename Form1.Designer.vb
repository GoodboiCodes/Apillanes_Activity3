...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 0
        Label1.Text = "Division Calculator"
        ' 
        ' Label2
        ' 
        ...
        lblResult.Location = New Point(215, 134)
        ...
        ' txtFirstnum
        ' 
        txtFirstnum.Location = New Point(170, 47)
        ...
        ' txtSecondnum
        ' 
        txtSecondnum.Location = New Point(170, 83)
        ...
        ' btnDivision
        ' 
        btnDivision.Location = New Point(38, 126)
